...
/**
 * A class view to obtain the name of the portfolio
 * whose value is to be displayed.
 */
public class ValueOfPortfolio1 extends AbstractView {
   ...
   */
  public ValueOfPortfolio1() {
    frame = new JFrame("Value of Portfolio");
  ...
  public void addActionListener(ActionListener listener) {
    button1.setActionCommand(ActionCommands.VALUE_PORTFOLIO_FINAL);
