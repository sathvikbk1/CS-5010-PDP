...
/**
 * A class view to get the name of the portfolio
 * to display the value on a particular date.
 */
public class ValueOnDate1 extends AbstractView {
  ...
  public void addActionListener(ActionListener listener) {
    button1.setActionCommand(ActionCommands.VALUE_ON_DATE_DATE);
