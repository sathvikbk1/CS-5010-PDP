...
/**
 * A class view to obtain the name of the portfolio to be retrieved.
 */
public class RetrievePortfolio1 extends AbstractView {
  ...
  public void addActionListener(ActionListener listener) {
    button1.setActionCommand(ActionCommands.RETRIEVE_PORTFOLIO_FINAL);
