...
/**
 * A class view to obtain the commission for the sell transaction.
 */
public class Sell5 extends AbstractView {
  ...
  public Sell5() {
    ...
    textField1 = new JTextField("Commission", 20);
  ...
  public void addActionListener(ActionListener listener) {
    button1.setActionCommand(ActionCommands.SELL_STOCK_FINAL);
