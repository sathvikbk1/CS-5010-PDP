 ...
 */
public class StrategyEndDate extends AbstractView {
   ...
   */
  public StrategyEndDate() {
    frame = new JFrame("Strategy End Date");
  ...
  public void addActionListener(ActionListener listener) {
    button1.setActionCommand(ActionCommands.STRATEGY_INTERVAL);
