...
/**
 * A class view to obtain the commission for each transaction.
 */
public class Strategy4 extends AbstractView {
  ...
  public void addActionListener(ActionListener listener) {
    button1.setActionCommand(ActionCommands.STRATEGY_PART1_FINAL);
