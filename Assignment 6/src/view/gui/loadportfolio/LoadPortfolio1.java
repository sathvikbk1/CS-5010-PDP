...
/**
 * A class view to load a particular portfolio to modify.
 */
public class LoadPortfolio1 extends AbstractView {
   ...
   */
  public LoadPortfolio1() {
    frame = new JFrame(" Load Portfolio ");
  ...
  public void addActionListener(ActionListener listener) {
    button1.setActionCommand(ActionCommands.LOAD_PORTFOLIO_FINAL);
