...
public class ControlImplTest {
  ...
  @Before
  public void setUp() {
    Stock st = new StockImpl("ibm", 10, 20);
    Stock stock = new StockFlexImpl("ibm", 10, 139, LocalDate.parse("2022-11-08"), 10);
    Stocks1.add(st);
    Portfolio p = new PortfolioImpl("ABC", Stocks1);
    Portfolio1.add(p);
    Stocks2.add(stock);
    Portfolio port = new PortfolioFlexImpl("XYZ", Stocks2, Stocks2, new ArrayList<>());
    Portfolio2.add(port);
  }
  ...
  /**
   * A test to check the functioning of the strategy.
   */
  @Test
  public void testDCA() {
    Reader in = new StringReader("2 1 3 googl 80 10 1 ibm 20 15 f PlanA " +
            "2022-11-10 2022-11-26 5 1000 f xyz 3 xyz q");
    StringBuilder out = new StringBuilder();
    StringBuilder otherLog = new StringBuilder();
    Control control = new ControlImpl(in, out);
    control.execute(new MockModelImpl(otherLog, Portfolio2, new ArrayList<>(), 10, true));
    assertEquals("Setting type to Flexible Portfolio\n" +
                    "Setting type to Flexible Portfolio\n" +
                    "The strategy name: PlanA\n" +
    ...
    assertEquals("Enter the type of portfolio to be created:\n" +
            ...
            "\n" +
            "Enter the corresponding to the operation to be performed:\n" +
            "1 - Add a new stock to strategy\n" +
            "f/F - finalize strategy\n" +
            "\n" +
            "Enter the stock name: \n" +
            "Enter the weightage of the stock: \n" +
            "Enter the commission for the stock: \n" +
            "Enter the custom date in yyyy-mm-dd format: \n" +
            "Invalid date entered!\n" +
            "Enter the custom date in yyyy-mm-dd format: \n" +
            "Enter the commission: \n" +
