...
/**
 * This is the test class for the Smart Calculator.
 */

public class SmartCalctest {
  Calculator s1;
  Calculator s2;

  @Before
  public void setup() {
    s1 = new SmartCalculator();
    s2 = new SmartCalculator();
  }
  ...
  @Test
  public void RegularExpression9() {
    s1 = s1.input('+');
    s1 = s1.input('5');
    s1 = s1.input('+');
    s1 = s1.input('2');
    s1 = s1.input('=');
    assertEquals("7", s1.getResult());
  }
  ...
  public void RegularExpression10() {
    ...
    assertEquals("5983", s1.getResult());
  }
  ...
  public void RegularExpression12() {
    ...
    s1 = s1.input('=');
    s1 = s1.input('=');
    assertEquals("-1621", s1.getResult());
  }
